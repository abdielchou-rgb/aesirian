...
def test_g9_markers():
    ...
    print(f"[PASS] G9 AI标志词检测: AI文本={ai_result.ai_marker_count} > 正常文本={normal_result.ai_marker_count}")
...
def test_to_gate_context():
    ...
    print(f"[PASS] 门禁上下文转换: facts={len(context['facts'])}, actions={len(context['char_actions'])}")
