...
from core.strategy_registry import (
    MethodologyRegistry, MethodologyNode, MethodologyNode as Node,
    MethodologyFamily as F, TriggerEvent as T, OutputType as O
)
...
def build_registry() -> MethodologyRegistry:
    ...
    reg.register(Node(
        id="M001", name="英雄之旅", family=F.NARRATIVE_STRUCTURE,
    ...
    reg.register(Node(
        id="M002", name="15节拍表", family=F.NARRATIVE_STRUCTURE,
    ...
    reg.register(Node(
        id="M003", name="5幕辩证结构", family=F.NARRATIVE_STRUCTURE,
    ...
    reg.register(Node(
        id="M004", name="7基本情节", family=F.NARRATIVE_STRUCTURE,
    ...
    reg.register(Node(
        id="M005", name="Story Spine", family=F.NARRATIVE_STRUCTURE,
    ...
    reg.register(Node(
        id="M010", name="31种叙事功能", family=F.NARRATIVE_ATOM,
    ...
    reg.register(Node(
        id="M011", name="36种戏剧情境", family=F.NARRATIVE_ATOM,
    ...
    reg.register(Node(
        id="M012", name="行动素模型", family=F.NARRATIVE_ATOM,
    ...
    reg.register(Node(
        id="M013", name="三态模型", family=F.NARRATIVE_ATOM,
    ...
    reg.register(Node(
        id="M014", name="故事与话语分析", family=F.NARRATIVE_ATOM,
    ...
    reg.register(Node(
        id="M020", name="五阶段模型", family=F.CREATIVE_COGNITION,
    ...
    reg.register(Node(
        id="M021", name="Geneplore生成-探索", family=F.CREATIVE_COGNITION,
    ...
    reg.register(Node(
        id="M022", name="SCAMPER 7操作", family=F.CREATIVE_COGNITION,
    ...
    reg.register(Node(
        id="M030", name="网文爽点系统", family=F.GENRE_CONTRACT,
        source="中国网文行业数千万部实战",
    ...
    reg.register(Node(
        id="M031", name="执念驱动", family=F.GENRE_CONTRACT,
        source="猫腻",
    ...
    reg.register(Node(
        id="M032", name="视觉锤+落地悬念", family=F.GENRE_CONTRACT,
        source="辰东",
    ...
    reg.register(Node(
        id="M040", name="7大角色系统", family=F.CHARACTER_SYSTEM,
    ...
    reg.register(Node(
        id="M041", name="Dramatica 4 Throughlines", family=F.CHARACTER_SYSTEM,
    ...
    reg.register(Node(
        id="M042", name="3维角色", family=F.CHARACTER_SYSTEM,
    ...
    reg.register(Node(
        id="M050", name="12章认知秘密", family=F.COGNITIVE_SCIENCE,
    ...
    reg.register(Node(
        id="M051", name="微张力", family=F.COGNITIVE_SCIENCE,
    ...
    reg.register(Node(
        id="M052", name="展示不告知谱系", family=F.COGNITIVE_SCIENCE,
    ...
    reg.register(Node(
        id="M060", name="Story Grid 5诫命", family=F.QUALITY_GATE,
    ...
    reg.register(Node(
        id="M061", name="MICE Quotient", family=F.QUALITY_GATE,
    ...
    reg.register(Node(
        id="M062", name="前提句完整性", family=F.QUALITY_GATE,
    ...
    reg.register(Node(
        id="M070", name="三维评估", family=F.ENGINEERING,
    ...
    reg.register(Node(
        id="M071", name="Pixar 22条", family=F.ENGINEERING,
    ...
    reg.register(Node(
        id="M072", name="发酵概念", family=F.ENGINEERING,
        source="中国网文行业实践",
    ...
    reg.register(Node(
        id="M073", name="三次驯化", family=F.ENGINEERING,
        source="Æsir 特有设计",
