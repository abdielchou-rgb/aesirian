...
_reg(GenreProfile(
    ...
    platform="publication_novel", pace="slow",
...
_reg(GenreProfile(
    ...
    platform="streaming_first", pace="fast",
    inciting_incident_deadline=5.0,
...
def list_profiles() -> list[dict]:
    return [
        {"id": p.id, "name": p.name, "description": p.description, "platform": p.platform, "pace": p.pace}
