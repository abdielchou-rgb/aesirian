...
引擎含一个**自研的「文鉴」规则审计系统（167 道门禁，单一真源 registry）**、一套**递归理论心智（ToM）**
...
| 🛡️ 文鉴门禁（167） | 场景价值翻转、黄金三章、断章、爽点、触点工程、跨章一致性等，纯规则可离线。计数派生自 `core/wenjian/audit/gates` 单一真源（V2 设计基线 145 + 风格一致性 22） |
